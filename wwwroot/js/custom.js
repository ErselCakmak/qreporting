...
function setThemeMode(mode) {
    $('body').toggleClass('dark-mode', mode === 'dark').removeClass('transparent-mode');
...
const themeMode = getCookie("themeMode") || "light";
...
$(document).ready(function () {
    ...
    if (bodyRtl) {
        ...
        (document.getElementById("style").setAttribute("href", "../vendor/bootstrap/css/bootstrap.rtl.min.css"));
